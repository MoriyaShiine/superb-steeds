...
- Horses no longer have determined statistics upon breeding, but instead every horse has a strength value from 1-5 in speed and jump.
    - This is shown in an extended section of the horse inventory GUI.
...
- You can feed horses while riding them by interacting with it with a food item (excluding hay bales) while looking down.
- Items apply their consume effects when fed to horses.
